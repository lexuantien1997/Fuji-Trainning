...
public class MessageConstant {
	public static final String USERID_ERR = "ユーザーIDを入力してください。";
	public static final String PASSWORD_ERR = "パスワードを入力してください。";
	public static final String USER_ERR = "ユーザーIDまたはパスワードが不正です。";
